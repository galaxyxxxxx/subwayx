<template>
	<el-table id="priceTable" :data="tableData.filter(data => !search || data.site.toLowerCase().includes(search.toLowerCase()))" style="width: 75%; margin: 20px auto;" :default-sort="{prop: 'line', order: 'ascending'}" v-model="price" >
		<el-table-column prop="line" label="线路" sortable width="300px" :sort-method="sortLine" align="center">
		</el-table-column>
